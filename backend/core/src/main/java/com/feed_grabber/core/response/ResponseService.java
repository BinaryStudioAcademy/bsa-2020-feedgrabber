...
public class ResponseService {
    ...
    public Optional<ResponseDto> update(ResponseUpdateDto dto) throws DeadlineExpiredException, NotFoundException {
...
//        }
    ...
    public ResponseDto getById(UUID responseId) throws ResponseNotFoundException {
        return ResponseMapper.MAPPER.responseToDto(responseRepository.findById(responseId)
